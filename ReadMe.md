...
<div align="center">
  ...
  ![GitHub repo size](https://img.shields.io/github/repo-size/mohammaddanishaftab/portfolio-website)
  ![GitHub stars](https://img.shields.io/github/stars/mohammaddanishaftab/portfolio-website?style=social)
  ![GitHub forks](https://img.shields.io/github/forks/mohammaddanishaftab/portfolio-website?style=social)
  ...
  <a href="https://mohammaddanishaftab.github.io/portfolio-website/"><strong>➥ Live Demo</strong></a>
...
```bash
sudo git clone https://github.com/mohammaddanishaftab/portfolio-website.git
```

Windows:

```bash
git clone https://github.com/mohammaddanishaftab/portfolio-website.git
```
...
This version updates all the references as per your request. Let me know if there's anything else you'd like to adjust!
